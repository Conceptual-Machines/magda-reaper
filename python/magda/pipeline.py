...
class MAGDAPipeline:
            ...
            if isinstance(value, str) and value.lower() in [
                ...
                if self.context_manager.current_selection:
                    ...
                    for obj_id in self.context_manager.current_selection:
                        ...
                        if obj and hasattr(
                            obj, "name"
                        ):  # Track objects have 'name' attribute
    ...
    def _update_context_from_result(
        self, operation_type: str, result: dict[str, Any], parameters: dict[str, Any]
    ) -> None:
        """Update context based on operation result."""
        ...
        if operation_type == "track":
            # Track creation
            track_name = parameters.get(
                "name", f"track_{len(self.context_manager.tracks)}"
            )
