...
class ContextManager:
    ...
    def __init__(self) -> None:
        ...
        self.objects_by_magda_id: dict[
            str, TrackObject | ClipObject | EffectObject | AutomationObject
        ] = {}
    ...
    def create_track(
        ...
        track_obj = TrackObject(
            magda_id=magda_id, daw_id=daw_id, name=name, track_type=track_type, vst=vst
        )
    ...
    def resolve_track_reference(self, reference: str) -> TrackObject | None:
        """
    ...
    def find_track_by_name(self, name: str) -> TrackObject | None:
        """Find a track by name (case-insensitive)."""
        return self.tracks_by_name.get(name.lower())

    def find_track_by_id(self, track_id: str) -> TrackObject | None:
    ...
    def get_track_effects(self, track_id: str) -> list[EffectObject]:
        ...
        return [
            ...
            for effect_id in self.tracks[track_id].effects
    ...
    def get_track_automations(self, track_id: str) -> list[AutomationObject]:
        ...
        return [
            self.automations[auto_id]
            for auto_id in self.tracks[track_id].automations
    ...
    def get_current_track(self) -> TrackObject | None:
