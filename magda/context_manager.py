...
class ContextManager:
    ...
    def create_track(
        ...
        track_obj = DAWObject(
            ...
            name=name,
            metadata={"type": track_type, "vst": vst},
        )
    ...
    def find_track_by_name(self, name: str) -> DAWObject | None:
    ...
    def find_track_by_id(self, track_id: str) -> DAWObject | None:
    ...
    def get_track_context(self, track_id: str) -> TrackContext | None:
    ...
    def add_clip(
        self, track_id: str, start_bar: int, end_bar: int, daw_id: str | None = None
    ) -> DAWObject | None:
    ...
    def resolve_track_reference(self, reference: str) -> DAWObject | None:
