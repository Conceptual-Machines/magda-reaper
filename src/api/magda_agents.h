...
public:
  ...
  bool DetectAgents(const char *question, AgentDetection &result,
  ...
  bool GenerateArranger(const char *question, WDL_FastString &out_dsl,
                        WDL_FastString &error);

  bool GenerateDrummer(const char *question, WDL_FastString &out_dsl,
                       WDL_FastString &error);
...
private:
  ...
  bool CallWithCFG(const char *model, const char *question,
  ...
  char *BuildAgentRequest(const char *model, const char *question,
                          const char *system_prompt, const char *tool_name,
                          const char *tool_description, const char *grammar);
