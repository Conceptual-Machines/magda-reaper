...
SWELL_DEFINE_DIALOG_RESOURCE_BEGIN(IDD_MAGDA_LOGIN, 0, "MAGDA Login", 400, 220, 1.0)
BEGIN
// Email label
LTEXT "Email:", -1, 20, 55, 60,
    ...
    // Cancel button
    PUSHBUTTON "Cancel",
    IDC_CANCEL_BUTTON, 290, 165, 80, 30 END SWELL_DEFINE_DIALOG_RESOURCE_END(IDD_MAGDA_LOGIN)
